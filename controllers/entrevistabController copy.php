	...
	public function fpersonal() {
		...
		if (isset($_SESSION['usuario'])) {
			...
			if ($regfinalista[0]['i_count'] > 0){
				...
				<section class='vertical-wizard'>
					<div class='bs-stepper vertical vertical-wizard-example'>
						<div class='bs-stepper-header'>
							<div id='1' class='step' data-target='#datos-personales'>
							...
							<div id='2' class='step' data-target='#hijos'>
							...
							<div id='3' class='step' data-target='#essalud'>
							...
							<div id='4' class='step' data-target='#rtps'>
						...
						<div class='bs-stepper-content'>
							...
							<div id='hijos' class='content'>
								<div class='content-header'>
									...
									<body style='text-align: justify;'>
										<small class='text'>Ingresar nombre y fecha de nacimiento de sus hijos, estos datos son importantes para la asignacion familiar mensual.
										...
										<table id='example' class='table table-bordered'>
											<thead class='thead-dark'>
												<tr class='text-center'>
													<th>#</th>
													<th>ACCIONES (¿Qué hace?, ¿Cómo lo hace?)</th>
													<th>RESULTADO FINAL ESPERADO (¿Para qué lo hace?)</th>
													<th># Eliminar</th>
												</tr>
											</thead>
											<tbody id='tablita-aci' class='text-center'>
											</tbody>
										</table>
									</div>
								</div>
							...
							<div id='essalud' class='content'>
								...
								<div class='row'>
									...
									<div class='col-sm-2'>
										<div class='form-group'>
											<label class='form-label font-weight-bolder'>TIENE SEGURO</label>
											<div class='input-group'>
							...
							<div id='rtps' class='content'>
								...
								<div class='row'>
									...
									<div class='form-group col-md-6'>
										<label class='form-label font-weight-bolder'>NIVEL DE EDUCACION <b class='text-danger'>(*)</b></label>
										<select id='niveleducacion' class='select2 form-control form-control-lg'>
											<?php echo $this->nivelD ?>
										</select>
									</div>
				...
				$this->_view->refpuesto = $refpuesto;
				$this->_view->tipodoc = $combotipodoc;
				$this->_view->civil = $combocivil;
				$this->_view->pais = $combopais;
				$this->_view->departamento = $combodepartamentos;
				$this->_view->provincia = $comboprovincia;
				$this->_view->distrito = $combodistrito;
				$this->_view->afp = $comboafp;
				$this->_view->nivelD = $combonivelD;
