...
namespace WSReclutamiento.Controller
{
    public class CRPAOrganizacion
    {
            ...
            Int32 user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_PUESTOA_ORGANIZACION", con);
            ...
            SqlParameter par4 = cmd.Parameters.Add("@puestos", SqlDbType.VarChar);
            par4.Direction = ParameterDirection.Input;
            par4.Value = puestos;

            SqlParameter par5 = cmd.Parameters.Add("@reportes", SqlDbType.VarChar);
