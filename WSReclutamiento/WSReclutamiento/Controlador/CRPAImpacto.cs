...
namespace WSReclutamiento.Controller
{
    public class CRPAImpacto
    {
            ...
            Int32 user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_PUESTOA_IMPACTO", con);
            ...
            SqlParameter par4 = cmd.Parameters.Add("@dimensiones", SqlDbType.VarChar);
            par4.Direction = ParameterDirection.Input;
            par4.Value = dimensiones;

            SqlParameter par5 = cmd.Parameters.Add("@magnitudes", SqlDbType.VarChar);
            par5.Direction = ParameterDirection.Input;
            par5.Value = magnitudes;
