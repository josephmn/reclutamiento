...
namespace WSReclutamiento.Controller
{
    public class CRPADecisiones
    {
            ...
            Int32 user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_PUESTOA_DECISIONES", con);
            ...
            SqlParameter par4 = cmd.Parameters.Add("@decisiones", SqlDbType.VarChar);
            par4.Direction = ParameterDirection.Input;
            par4.Value = decisiones;

            SqlParameter par5 = cmd.Parameters.Add("@recomendaciones", SqlDbType.VarChar);
            par5.Direction = ParameterDirection.Input;
            par5.Value = recomendaciones;
