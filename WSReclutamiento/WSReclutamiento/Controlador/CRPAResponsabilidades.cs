...
{
    public class CRPAResponsabilidades
    {
            ...
            Int32 user)
        {
            ...
            SqlCommand cmd = new SqlCommand("ASP_MANT_PUESTOA_RESPONSABILIDADES", con);
            ...
            SqlParameter par4 = cmd.Parameters.Add("@acciones", SqlDbType.VarChar);
            par4.Direction = ParameterDirection.Input;
            par4.Value = acciones;

            SqlParameter par5 = cmd.Parameters.Add("@resultados", SqlDbType.VarChar);
            par5.Direction = ParameterDirection.Input;
            par5.Value = resultados;

            SqlParameter par6 = cmd.Parameters.Add("@user", SqlDbType.VarChar);
