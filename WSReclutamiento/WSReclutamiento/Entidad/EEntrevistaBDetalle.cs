...
namespace WSReclutamiento.Entity
{
    ...
    {      
        ...
        public string v_finalista { get; set; }        
        public string v_descr_finalista { get; set; }
        public string v_correo_enviado { get; set; }
    }
}