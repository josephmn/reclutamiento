...
(function (window, document, $) {
  ...
  var basicPickr = $(".flatpickr-basic"),
    ...
    disabledateTimePickr = $(".flatpickr-disable-date-time"),
  ...
  // Date & TIme disable range
  if (disabledateTimePickr.length) {
    disabledateTimePickr.flatpickr({
      // weekNumbers: true,
      enableTime: true,
      disable: [
        {
      ...
      locale: {
        firstDayOfWeek: 1, // la semana inicia el lunes
      },
      defaultDate: false,
    });
  }
